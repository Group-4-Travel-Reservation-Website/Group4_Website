...
<div id="customer_service">
	...
	<div>
		...
		<button
			...
			style="width: 150px; height: 60px; margin-top: 30px; margin-left: 670px; font-size: 16px; font-weight: bold; border: none; background-color: gray; color: white;">문의하기</button>
	</div>
</div>
