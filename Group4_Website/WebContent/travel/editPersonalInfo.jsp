	...
	<div id="editPersonalInfo">
		...
		<table style="margin-top: 50px; font-size: 15px; text-align: left;width: 100%;">
			...
			<tr>
				...
				<td class="res_table_td_2" style="height: 60px;"><input
					class="input_table" type="text" name="password" placeholder="비밀번호" id="password" /></td>
			</tr>
			<tr>
				<td class="res_table_td_1" style="width: 100px;">이메일</td>
				<td class="res_table_td_2" style="height: 60px;"><input
					class="input_table" type="text" name="email_id"
					placeholder="이메일" id="email" style="width: 250px;"/>&nbsp;&nbsp;></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="res_table_td_2" style="height: 60px;"><input
					class="input_table" type="text" name="birth" placeholder="예)20180101" id="birth" /></td>
			</tr>
		</table>
		...
		<button onclick="check2();" style="width: 280px; height: 70px;font-size: 18px; color: white; background-color: #2F9D27; margin-top: 40px;float: right;font-weight: bold;border: none;">수정완료</button>
