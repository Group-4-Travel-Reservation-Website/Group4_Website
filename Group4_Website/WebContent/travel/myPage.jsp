...
<div id="my_page">
	...
	<div id="res_top" style="border: none; height: 200px; background-color: #FFFFDA;">
		<div id="category">
			<h1 id="txt_category" style="padding-right: 20px;">홈 > 마이페이지</h1>
		</div>

		<div
			style="height: 50px; width: 800px; position: relative; top: 100px; left: 20px; font-size: 30px; font-weight: 500; padding-top: 20px; padding-left: 10px; margin-bottom: 40px;">
			안녕하세요, <span style="color: green; font-weight: bold;">홍길동</span>님!
		</div>
	</div>
	...
	<div class="res_description">
		...
		<div id="ask_ser">
			...
			<table class="res_table"
				style="border-top: 2px solid #D5D5D5; border-bottom: 2px solid #D5D5D5; width: 100%;">
				<tr align="center">
					<td class="ask_ser_td" style="border-left:2px solid #EAEAEA; border-right: 2px solid #EAEAEA;padding-top: 10px;"><img src="../image/home.jpg"
						width="90%;" height="90%"></td>
					<td class="ask_ser_td" style="border-right: 2px solid #EAEAEA;padding-top: 10px;"><img src="../image/coupon.png"
						width="55%;" height="55%"></td>
					<td class="ask_ser_td" style="; border-right: 2px solid #EAEAEA;padding-top: 10px;"><img src="../image/shoppingCart.png"
