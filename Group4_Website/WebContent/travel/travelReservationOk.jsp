...
<div id="travel_reservation_ok">
	...
	<div class="res_description"
		...
		<img src="../image/img1.jpg" width=150px height=150px
			style="margin-top: 50px;">
		<p class="travel_reservation_ok_p" style="margin-top: 20px;">웹 투어를
			이용해주셔서 감사합니다.</p>
		<p class="travel_reservation_ok_p">
			<span style="color: green; font-size: 18px;">홍길동 </span>님의 예약이
			완료되었습니다.
		</p>
		<div
			style="border-radius: 7px; background-color: #FFC72C; font-size: 14px; height: 30px; width: 200px; margin-top: 10px; margin-left: auto; margin-right: auto; line-height: 30px;">
			예약 번호는 <span style="color: green;">283794</span> 입니다.
		</div>
	</div>
	...
	<div class="res_description" style="margin-top: 25px; font-size: 20px;">
		상품 정보
	...
	<div class="res_description" style="font-size: 20px; margin-top: 50px;">
		예약자 정보
		<div
